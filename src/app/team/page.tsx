...
export default function TeamPage() {
  ...
  const [zileExceptate, setZileExceptate] = useState<any[]>([])
  ...
  useEffect(() => {
    const init = async () => {
      ...
      if (u.role === 'director') {
        ...
        await loadSummaries(members, from, to, zileEx || [])
      } else {
        ...
        await loadSummaries(uniqueMembers, from, to, zileEx || [])
      }
  ...
  const esteZiExceptata = (date: string, zileEx: any[]) => {
          ...
          <>
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <p className="text-slate-500 mt-1">Click pe un angajat pentru detalii pontaj</p>
              </div>
              <LastUpdated />
            </div>
